 ...
 * Spreadsheet: https://docs.google.com/spreadsheets/d/1_Zf-ecWOLUg_BiJu9LuE0i7wmJDT9sn8b7HAWKFi98w
 *
 * HOW TO RUN:
...
function getPermanentClassRows_() {
  return [
    ...
    ['Metadata', 'DPD'],
    ['Language', 'CX Preferred Language'],
    ['Language', 'Bot Spoken Language'],
